...
```bash
cd mcp/
python demos/04_memory_attacks/demo.py
```

**Nota**: O servidor cria um ficheiro `memory.json` na pasta `demos/04_memory_attacks/` para persistência entre execuções. Apaga este ficheiro para "limpar" a memória.
